-- -----------------------------------
-- Table structure for `sites_04_02_2025`
-- -----------------------------------

DROP TABLE IF EXISTS `sites_04_02_2025`;
CREATE TABLE `sites_04_02_2025` (
  ...
  KEY `idx_sites_04_02_2025` (`NewPanelID`,`ATMID`),
  KEY `server_ip` (`server_ip`),
  KEY `idx_old_panelid` (`OldPanelID`),
  KEY `idx_new_panelid` (`NewPanelID`)
) ENGINE=MyISAM AUTO_INCREMENT=7050 DEFAULT CHARSET=latin1;
